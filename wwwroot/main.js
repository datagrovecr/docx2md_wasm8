...
window.convertToMd = (input) => {
    ...
    reader.onload = async function (e) {
      ...
      var zipBytes = await DotNet.invokeMethodAsync("docx2md_wasm8", "openDocxZipFile", new Uint8Array(reader.result), file.name);
  ...
  window.convertToDocx = async (input) => {
    ...
    if (file.type == "application/zip") {
      ...
      jszip.loadAsync(file).then(async function (zip) {
        ...
        var zipBytes = await DotNet.invokeMethodAsync("docx2md_wasm8", "openMdZipFile", mdString, jsonString);
      ...
      reader.onload = async function (e) {
        ...
        var byte = await DotNet.invokeMethodAsync("docx2md_wasm8", "openMdFile", new Uint8Array(reader.result));;
